...
pub(crate) unsafe fn restore_trace_function() {
    ...
    unsafe {
        patch_function(
            __yk_trace_basicblock as usize,
            addr_of!(ORIGINAL_INSTRUCTIONS).cast::<u8>(),
            1,
        );
    }
}
...
//                 1,
//             );
//             patch_function(test_function as usize, addr_of!(PATCH_X86_INSTRUCTIONS).cast::<u8>(), 1);
//             assert_eq!(test_function(), 0);
//             patch_function(test_function as usize, addr_of!(ORIGINAL_INSTRUCTIONS).cast::<u8>(), 1);
//             assert_eq!(test_function(), 42);
//         }
//     }
// }
